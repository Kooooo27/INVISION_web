...
const IOSInstallPrompt = ({ onDismiss }) => {
    ...
    const steps = [
        { icon: '□↑', title: '共有ボタンをタップ', desc: '画面下部の共有アイコン（□に↑）をタップしてください', visual: '01' },
        { icon: '＋', title: '「ホーム画面に追加」をタップ', desc: 'メニューをスクロールして「ホーム画面に追加」を選択', visual: '02' },
        { icon: '✓', title: '「追加」をタップ', desc: '右上の「追加」ボタンをタップして完了！', visual: '03' }
    ];
    return (
